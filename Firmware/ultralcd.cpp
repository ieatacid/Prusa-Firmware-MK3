...
void unload_filament()
{
    ...
    // Extrude before unloading - JASON
    current_position[E_AXIS] += 10 ; // amount to feed                                                                   feed rate
    //                                                                                                                        V
	plan_buffer_line(current_position[X_AXIS], current_position[Y_AXIS], current_position[Z_AXIS], current_position[E_AXIS], 10.0, active_extruder);
    st_synchronize();
...
void setLiveZ(float z_change, bool absolute)
{
    /*
    Z baby step: -280
    ...
    */
    ...
    {
        float new_z = current_z / axis_steps_per_unit[Z_AXIS];
        new_z += z_change;
